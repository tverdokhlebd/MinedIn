...
class ZcashRequestor extends Requestor {
    ...
    /** API url. */
    private static final String API_URL = "https://api-zcash.flypool.org/miner/:miner/currentStats";
    /** Cached accounts. */
    ...
    static {
        startRepeatedTask(ZcashRequestor.class.getName(), new TimerTask() {
     ...
     */
    ZcashRequestor(OkHttpClient httpClient, boolean useAccountCaching) {
