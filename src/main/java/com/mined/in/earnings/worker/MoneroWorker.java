...
/**
 * Worker for calculating monero earnings.
 *
 * @author Dmitry Tverdokhleb
 *
 */
class MoneroWorker implements EarningsWorker {
     ...
     */
    MoneroWorker(AccountRequestor accountRequestor, MarketRequestor marketRequestor, RewardRequestor rewardRequestor) {
        super();
    ...
    public Earnings calculate(String walletAddress)
        ...
        Account account = accountRequestor.requestMoneroAccount(walletAddress);
        ...
        Reward reward = rewardRequestor.requestMoneroReward(account.getReportedHashrate());
