...
/**
 * Worker for calculating zcash earnings.
 *
 * @author Dmitry Tverdokhleb
 *
 */
class ZcashWorker implements EarningsWorker {
     ...
     */
    ZcashWorker(AccountRequestor accountRequestor, MarketRequestor marketRequestor, RewardRequestor rewardRequestor) {
        super();
    ...
    public Earnings calculate(String walletAddress)
        ...
        Account account = accountRequestor.requestZcashAccount(walletAddress);
        ...
        Reward reward = rewardRequestor.requestZcashReward(account.getReportedHashrate());
