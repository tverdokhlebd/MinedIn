...
/**
 * Worker for calculating ethereum classic earnings.
 *
 * @author Dmitry Tverdokhleb
 *
 */
class EthereumClassicWorker implements EarningsWorker {
     ...
     */
    EthereumClassicWorker(AccountRequestor accountRequestor, MarketRequestor marketRequestor, RewardRequestor rewardRequestor) {
        super();
    ...
    public Earnings calculate(String walletAddress)
        ...
        Account account = accountRequestor.requestEthereumClassicAccount(walletAddress);
        ...
        Reward reward = rewardRequestor.requestEthereumClassicReward(account.getReportedHashrate());
