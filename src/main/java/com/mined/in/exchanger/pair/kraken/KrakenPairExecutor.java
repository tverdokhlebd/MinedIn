...
/**
 * Implementation of Kraken executor.
 *
 * @author Dmitry Tverdokhleb
 *
 */
public class KrakenPairExecutor implements PairExecutor {
    ...
    /**
     * Creates the Kraken executor instance.
     *
     * @param httpClient HTTP client
     */
    public KrakenPairExecutor(OkHttpClient httpClient) {
        super();
