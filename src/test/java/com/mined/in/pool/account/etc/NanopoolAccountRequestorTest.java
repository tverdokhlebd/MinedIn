...
public class NanopoolAccountRequestorTest {
    ...
    private final static String WALLET_ADDRESS = "0x16ba5429eb869ebb4b9241bba127e8acb40ccc64";
    private static final MediaType MEDIA_JSON = MediaType.parse("application/json");

    @Test
    public void testCorrectJsonResponse() throws AccountRequestorException {
        JSONObject responseBalance = new JSONObject("{\"status\":true,\"data\":2.4388690613122}");
        JSONObject responseReportedHashrate =
                new JSONObject("{ \"status\": true, \"data\": 8249.964 }");
