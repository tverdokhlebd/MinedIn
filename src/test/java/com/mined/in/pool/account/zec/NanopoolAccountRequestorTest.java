...
public class NanopoolAccountRequestorTest {
    ...
    public void testCorrectJsonResponse() throws AccountRequestorException {
        JSONObject responseBalance = new JSONObject("{\"status\":true,\"data\":0.377654816907192}");
        JSONObject responseReportedHashrate =
                new JSONObject("{ \"status\": true, \"data\": 0 }");
        ...
        assertEquals(BigDecimal.valueOf(0.377654816907192), account.getWalletBalance());
